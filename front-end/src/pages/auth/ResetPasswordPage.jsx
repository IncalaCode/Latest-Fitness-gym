...
import { FiLock, FiHome, FiEye, FiEyeOff, FiCheckCircle } from 'react-icons/fi';
...
const ResetPasswordPage = () => {
  ...
  const handleSubmit = async (values, { setSubmitting }) => {
    ...
    const success = await resetPassword({
      token: id, // Use the id from URL params as the token
      ...
      <div className="min-h-screen flex flex-col items-center justify-center bg-gray-900 p-4">
        <div className="bg-gray-800 rounded-xl p-8 max-w-md w-full text-center">
          ...
          <Link to="/forgot-password">
            <PrimaryButton colorScheme="redOrange" className="w-full py-3 mb-4">
              ...
              >
                ...
                <div className="relative h-full flex flex-col justify-center p-12 text-white z-10">
                  ...
                  <blockquote className="text-xl italic mb-8">
                    "Create a strong password to keep your fitness journey secure. You're just one step away from getting back on track."
                  </blockquote>
                          ...
                          <div className="mb-6">
                            ...
                            <div className="relative">
                              ...
                              <Field
                                ...
                                } rounded-lg py-3 px-4 pl-10 pr-10 text-white focus:outline-none focus:ring-2 focus:ring-red-500`}
