...
import { Check, X, Loader, Eye, ExternalLink } from "lucide-react";
    ...
    <div className="p-6">
      ...
      >
        ...
        <div className="fixed inset-0 flex items-center justify-center p-4">
          <Dialog.Panel className="relative bg-white rounded-lg max-w-3xl mx-auto p-6 shadow-xl">
      ...
      >
        ...
        <div className="fixed inset-0 flex items-center justify-center p-4">
          <Dialog.Panel className="relative bg-white rounded-lg max-w-2xl mx-auto p-6 shadow-xl">
            <div className="flex justify-between items-center mb-4">
              <Dialog.Title className="text-lg font-medium">
                Payment Details
              </Dialog.Title>
            ...
            {selectedPayment && (
              <>
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div>
                        ...
                        <p className="font-medium">{selectedPayment.txRef || "N/A"}</p>
                      </div>
                      <div>
                ...
                {selectedPayment.paymentimage && (
                  <div className="mt-6">
                    <h3 className="text-md font-medium mb-3">Payment Proof</h3>
