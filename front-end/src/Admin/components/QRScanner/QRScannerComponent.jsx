...
import { AlertCircle, CheckCircle, RefreshCw, Loader, Snowflake, Calendar } from "lucide-react";
      ...
      return (
        <div className="flex flex-col items-center justify-center p-4 sm:p-6 bg-gray-50 rounded-lg border border-gray-200">
          ...
          <p className="text-base sm:text-lg font-medium text-gray-700">
            {loading ? "Verifying QR code..." : "Unfreezing membership..."}
          </p>
        </div>
      );
    }
    ...
    if (unfreezeSuccess) {
      return (
        <div className="flex flex-col items-center justify-center p-4 sm:p-6 bg-green-50 rounded-lg border border-green-200">
          ...
          <p className="text-base sm:text-lg font-medium text-green-700 mb-2">Membership Unfrozen</p>
          <p className="text-center text-green-600 mb-4 text-sm sm:text-base">
    ...
    if (error) {
      ...
      if (error.includes('Membership is frozen')) {
        try {
          ...
          return (
            <div className="flex flex-col items-center justify-center p-4 sm:p-6 bg-blue-50 rounded-lg border border-blue-200">
              <Snowflake className="h-8 w-8 sm:h-12 sm:w-12 text-blue-500 mb-3 sm:mb-4" />
              <p className="text-base sm:text-lg font-medium text-blue-700 mb-2">Membership is Frozen</p>
              ...
              <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3 w-full sm:w-auto">
                ...
                <button
                  ...
                  className="px-3 py-1.5 sm:px-4 sm:py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors text-sm sm:text-base w-full sm:w-auto"
                >
                  Unfreeze Membership
                </button>
              </div>
